...
=======
      ...
      <div className="flex flex-col items-center justify-center text-center text-white h-full">
        ...
        />
        <h1 className="font-extrabold mb-5 big-title leading-none tracking-tight title-settings">
          A New Sunrise for Speech Therapy: <span className="divisore"></span>
          Development of{" "}
          <span className="text-yellow-500"> SoundRise 2.0 </span> Application
        </h1>
        <p className="mb-2 leading-none tracking-tight text-small-desc">
          SoundRise is an educational application with the aim of assisting
          people, especially children and adolescents, in their vocal learning
          journey. Designed to be used as an extra support to a speech therapy
          pathway for young patients with hearing and communication
          difficulties, it combines the worlds of technology and education, with
          a focus on inclusivity.
          <br />
          <br />A friendly sun represents the tonal and timbral characteristics
          of the user&apos;s voice. When a vocal is emitted, the sun wakes up
          and smiles, and, based on note pitch, intensity, and timbre, changes
          its vertical position, size, and color, all in real time. This visual
          system helps to understand how one&apos;s voice works.
        </p>
        <div className="relative flex max-h-screen flex-col items-center">
          <SunAwake
            svgColor={"yellow"}
