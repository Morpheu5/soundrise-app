    ...
    <nav className="leading-none text-2xl bg-gradient-rgba text-sky-100 p-4 z-40 fixed top-0 w-full ">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden sm:flex items-center">
          ...
          <Link to="/about" className="ml-4 text-lg font-semibold">
            ABOUT
          </Link>
          <Link to="/play" className="ml-4 text-lg font-semibold">
            RUN APP
          </Link>
          <Link
            to="https://github.com/zGiada/soundrise-app" target="_blank"
